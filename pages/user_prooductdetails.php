...
?>
                        ...
                        while($res = mysqli_fetch_array($result)){
                                    ...
                                    if (isset($_POST['submit'])){
                                        ...
                                        mysqli_query($dbconn,"INSERT INTO order_details (order_details_id, prod_id,prod_qty,total_qty,total,user_id,order_id) 
                                                VALUES ('$order_details_id','$prod_id','$prod_qty','$total_qty','$total','$user_id','$order_id')") or die(mysql_error());
                                            ?>
