<?php
    ...
    if (!isset($_SESSION['id']) ||(trim ($_SESSION['id']) == '')) {
        header('location:userlogin_form.php');
        exit();
    }
?>
    ...
    <h5>[ <small><?php echo $count2;?> </small>] types of item.</h5>  
      ...
      <table class="table table-condensed table-bordered">
          ...
          ?>
              ...
              <tr>
                  <td> <img width="150" height="100" src="../pics/<?php echo $row2['prod_pic1'];?>" alt=""/></td>
                  ...
                  <td>     
                    ...
                    <a href="edit_order_details.php?order_id=<?php echo $row['order_details_id'];?>" >Add More</a>
                      <a href="delete_order_details.php?order_id=<?php echo $row['order_details_id'];?>" >Delete</a>
                  </td>
