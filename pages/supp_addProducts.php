        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                      ...
                      <hr color="orange">
                      <a href='supp_index.php' class='btn btn-warning btn-round'>Back to Index</a>
                <br>
                <div class="col-md-12">
...
if(isset($_POST['submit'])){
   ...
   $supp_id=$_SESSION['id'];               //ID OF SUPPLIER

    move_uploaded_file($_FILES["prod_pic1"]["tmp_name"],"../pics/" . $_FILES["prod_pic1"]["name"]);         
    $prod_pic1=$_FILES["prod_pic1"]["name"];
    move_uploaded_file($_FILES["prod_pic2"]["tmp_name"],"../pics/" . $_FILES["prod_pic2"]["name"]);         
    $prod_pic2=$_FILES["prod_pic2"]["name"];
    move_uploaded_file($_FILES["prod_pic3"]["tmp_name"],"../pics/" . $_FILES["prod_pic3"]["name"]);         
    ...
    if(empty($prod_name) || empty($prod_desc) || empty($prod_qty) || empty($prod_cost) || empty($prod_price) || empty($category) 
        ...
        $query = "INSERT INTO products (prod_name,supp_id, prod_desc, prod_qty, prod_cost, prod_price, category, prod_serial, prod_pic1, prod_pic2, prod_pic3) 
        VALUES ('$prod_name','$supp_id','$prod_desc','$prod_qty','$prod_cost','$prod_price','$category','$prod_serial','$prod_pic1','$prod_pic2','$prod_pic3')";  
        ...
        // header("Location: admin_panel.php");
         ...
         echo "<script>alert('Falya try kar')</script>";
        }
