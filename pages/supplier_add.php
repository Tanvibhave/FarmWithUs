...
if(isset($_POST['submit'])){
    ...
    if(empty($supp_name) || empty($supp_address) || empty($supp_contact) || empty($supp_email)){    
        ...
        $query = "INSERT INTO supplier (supp_name, supp_address, supp_contact, supp_email, supp_uname , supp_password) 
        VALUES ('$supp_name','$supp_address','$supp_contact','$supp_email' , '$supp_uname' , '$supp_password')";  
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form group">
                    ...
                    <input type="text" class="form-control" id="supp_email" name="supp_email" placeholder="Email@email.com"/>
                      ...
                      <label for="supp_contact">Supplier username</label>
                    <input type="text" class="form-control" id="supp_contact" name="supp_uname" placeholder="username"/>
                    <label for="supp_email">password:</label>
                    <input type="text" class="form-control" id="supp_email" name="supp_password" placeholder="password"/>
